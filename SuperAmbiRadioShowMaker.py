...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Drum" in str(filepath))  and ("Ambient" in str(filepath)): 
            contentbeats.append(filepath)

        if  filepath.endswith(".wav") and ("Pad" in str(filepath))  and ("Ambient" in str(filepath)) :
            contentdrones.append(filepath)

        if  filepath.endswith(".wav") and ("Bass" in str(filepath)) and ("Ambient" in str(filepath)) :
            contentbass.append(filepath)

        if  filepath.endswith(".wav") and ("One Shot" in str(filepath)) and ("Organ" in str(filepath)) :
            contentorg.append(filepath)

        if  filepath.endswith(".wav") and ("String" in str(filepath)) and ("Ambient" in str(filepath))  :
            contentsax.append(filepath)

        if  filepath.endswith(".wav") and ("Synth" in str(filepath)) and ("Ambient" in str(filepath))  :
