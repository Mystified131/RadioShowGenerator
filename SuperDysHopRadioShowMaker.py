...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Drums" in str(filepath)) or ("Hip Hop" in str(filepath)) : 
            contentbeats.append(filepath)

        if  filepath.endswith(".wav") and ("Sequence" in str(filepath))  and ("Dystopia" in str(filepath)) :
        ...
        if  filepath.endswith(".wav") and ("Strings" in str(filepath)) and ("Dystopia" in str(filepath)) :
            contentorg.append(filepath)

        if  filepath.endswith(".wav") and ("Fx" in str(filepath)) and ("Dystopia" in str(filepath))  :
            contentsax.append(filepath)

        if  filepath.endswith(".wav") and ("Synth" in str(filepath)) and ("Dystopia" in str(filepath))  :
