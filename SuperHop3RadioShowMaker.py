...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Rhodes" in str(filepath)) :
        ...
        if  filepath.endswith(".wav") and ("Boom" in str(filepath)) and ("Blip" in str(filepath)) :
            contentorg.append(filepath)

        if  filepath.endswith(".wav") and ("Hip Hop - Juicy" in str(filepath)) and ("Strings" in str(filepath))  :
            contentsax.append(filepath)

        if  filepath.endswith(".wav") and ("Hip Hop - Juicy" in str(filepath)) and ("Special" in str(filepath))    :
            contentgit.append(filepath)

        if  filepath.endswith(".wav") and ("Spektral" in str(filepath)) and ("Pad" in str(filepath)):
