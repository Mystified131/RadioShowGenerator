...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Pad" in str(filepath))  and ("Soul" in str(filepath)) :
             
            contentdrones.append(filepath)

        if  filepath.endswith(".wav") and ("Percussion" in str(filepath))  and ("Funk" in str(filepath)) :
        ...
        if  filepath.endswith(".wav") and ("Strings" in str(filepath)) and ("Score" in str(filepath)):
             
            contentorg.append(filepath)

        if  filepath.endswith(".wav") and ("Brass" in str(filepath)) and ("Score" in str(filepath)) :
             
            contentsax.append(filepath)

        if  filepath.endswith(".wav") and  ("Choir" in str(filepath)) and ("Score" in str(filepath)) :
