...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and (("Synth" in str(filepath)) and ("Glitch" in str(filepath))) :
        ...
        if  filepath.endswith(".wav") and ("Vocal" in str(filepath)) and ("Score" in str(filepath)) :
            contentgit.append(filepath)

        if  filepath.endswith(".wav") and ("Score" in str(filepath)) and ("Pad" in str(filepath)) :
