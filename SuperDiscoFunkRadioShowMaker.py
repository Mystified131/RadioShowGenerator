...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and (("Drums" in str(filepath)) or ("Beat" in str(filepath))) and ("House" in str(filepath)): 
        ...
        if  filepath.endswith(".wav") and ("Keys" in str(filepath)) and ("Funk" in str(filepath))  :
