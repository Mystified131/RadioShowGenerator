...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and (("Drums" in str(filepath)) or ("Beat" in str(filepath))) and ("Disco" in str(filepath)): 
        ...
        if  filepath.endswith(".wav") and ("Bass" in str(filepath)) and ("Disco" in str(filepath)) :
            contentbass.append(filepath)

        if  filepath.endswith(".wav") and ("Clap" in str(filepath)) and ("Disco" in str(filepath)) :
            contentorg.append(filepath)

        if  filepath.endswith(".wav") and ("Pad" in str(filepath)) and ("Disco" in str(filepath))  :
            contentsax.append(filepath)

        if  filepath.endswith(".wav") and ("Drone" in str(filepath)) and ("Disco" in str(filepath))  :
